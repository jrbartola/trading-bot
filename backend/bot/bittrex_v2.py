...
def post_requests(request_url, apisign, data):
...
class Bittrex(object):
    ...
    def _api_query(self, protection=None, path_dict=None, options=None):
        ...
        try:
            ...
            if API_V2_0 in path_dict and ('tradesell' in path_dict[API_V2_0] or 'tradebuy' in path_dict[API_V2_0]):
                print("Now using postss......")
                return post_requests(request_url, apisign, options)
            ...
            return {
                'success': False,
                'message': 'NO_API_RESPONSE: ' + e.message,
                'result': None
            }
