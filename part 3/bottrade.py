...
class BotTrade(object):
    def __init__(self, currentPrice, amtBtc, stopLoss=0):
        self.output = BotLog()
        self.status = "OPEN"
        self.entryPrice = currentPrice
        self.exitPrice = ""
        self.output.log("Trade opened")
        self.amount = amtBtc / currentPrice
        if stopLoss:
    ...
    def close(self,currentPrice):
        ...
        return (self.amount * self.exitPrice) - (self.amount * self.entryPrice), self.amount * self.exitPrice
